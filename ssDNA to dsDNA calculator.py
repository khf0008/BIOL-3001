...
Startup = "y" #initializes while loop so user can grade for as long as they want
while Startup == "y":
    ...
    print("\n")
    Startup = input("Enter 'y' to continue. Make sure it's lowercase: ") #allows the user to re-start the loop if they need to keep grading
    print("\n")
